            ...
            <tr>
                ...
                <td>
                    @if($irs->jadwal)
                        ...
                        @if($irs->jadwal->pengampu_2), {{ $irs->jadwal->pengampu_2 }} @endif
                        @if($irs->jadwal->pengampu_3), {{ $irs->jadwal->pengampu_3 }} @endif
                    @else
                        -
                    @endif
                </td>
                <td>
                    @if($irs->jadwal)
                        {{ $irs->jadwal->hari ?? '-' }}, {{ $irs->jadwal->jam_mulai }} - {{ $irs->jadwal->jam_selesai }}
                    @else
                        -
                    @endif
                </td>
