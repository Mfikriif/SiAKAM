                ...
                <table class="w-11/12 mx-auto text-center mt-10 border-separate border-spacing-y-3 pb-8">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>50</td>
                            <td>E101,E102,E103,A303,A304,K101,K102</td>
                            <td>
                                <button class="w-16 h-7 bg-[#FD3D3D] text-white text-sm rounded-lg">Tolak</button>
                                <button class="w-16 h-7 bg-[#4BC037] text-white text-sm rounded-lg">Terima</button>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>S1-STATISTIKA</td>
                            <td>50</td>
                            <td>F101,F102,F103,K203,K202</td>
                            <td>
                                <button class="w-16 h-7 bg-[#FD3D3D] text-white text-sm rounded-lg">Tolak</button>
                                <button class="w-16 h-7 bg-[#4BC037] text-white text-sm rounded-lg">Terima</button>
                            </td>
