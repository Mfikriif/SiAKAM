...
<body class="flex flex-col min-h-screen bg-gradient-to-r from-fuchsia-800 to-pink-500">
    ...
    <main class="flex-1">
        <section class="w-11/12 mx-auto relative top-36 bg-white rounded-lg pt-5 pb-6">
            <div class="container-table">
                ...
                <div class="overflow-x-auto mb-4" id="pengajuanJadwalContainer">
                    ...
                    @else
                        @include('dekan.partialPengajuanJadwal')
                    @endif
                </div>
            </div>
        </section>
    ...
    <script>
        ...
        document.addEventListener('click', function (e) {
            if (e.target.closest('#paginationLinksPengajuanJadwal a')) {
                e.preventDefault();
                ...
                fetch(url, {
                    ...
                    .then(html => {
                        document.getElementById('pengajuanJadwalContainer').innerHTML = html;
                    })
