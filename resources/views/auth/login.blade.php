            ...
            <div class="text-center">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="flex items-center border rounded-lg p-2 mt-5">
                        ...
                        <input type="text" name="email" placeholder="Email" class="flex-1 border-none bg-transparent pl-4" required autofocus>
                    </div>
                    @error('email')
                    ...
                    <div class="flex items-center border rounded-lg p-2 mt-3">
                        ...
                        <input type="password" name="password" placeholder="Password" class="flex-1 border-none bg-transparent pl-4" required>
                    </div>
                    @error('password')
                        <span class="text-red-500 text-xs">{{ $message }}</span>
                    @enderror
