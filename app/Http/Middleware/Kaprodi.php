...
class Kaprodi
{
    ...
    {
        // Retrieve the user's roles from session or determine them if not set
        ...
        // If the selected roles do not include 'kaprodi', redirect based on their primary role
        if (!in_array('kaprodi', $selectedRoles)) {
